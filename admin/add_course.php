...
if(isset($_POST['submit']))
{
    ...
    $add="INSERT INTO course (ccode,cname,cfile,category,subscription,amount) VALUES ('$cid','$cname','$cfile','$cat','$sub','$amt')";
...
<header class="header" id="header">
    ...
    <form class="cen" method="POST" action=""><br>
  ...
  <label class="custom-file-label col-sm-2" for="customFile">Choose file</label>
    <div class="col-sm-5">
    <input type="file" class="custom-file-input  mar form-control" id="customFile" name="cfile">
   </div>
  </div>
  <br>
  
  <div class="form-group row">
  <label class="custom-file-label col-sm-2" for="customFile">Course Category</label>
    <div class="col-sm-5">
    <select class="custom-select form-control" name="ccourse">
  ...
  <label class="custom-file-label col-sm-2" for="customFile">Subscription Type</label>
    <div class="col-sm-5">
    <select class="custom-select form-control" name="csub">
  ...
  <label class="custom-file-label col-sm-2" for="customFile">Subscribe Amount</label>
    <div class="col-sm-5">
    <select class="custom-select form-control" name="camt" >
  <option selected>Open this select menu</option>
  ...
  <button type="submit" class="btn bt btn-outline-primary" name="submit">ADD</button>
</form>
    </body>
    </html>