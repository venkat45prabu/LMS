...
<center><b><li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="feedbacks.php?q=0">Feedback<span class="sr-only"></span></a></li></b></center>
		...
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="feedbacks.php?q=3">Feedback</a></li> -->
<!--         
